    ...
    <div className="container mx-auto flex w-full flex-col xl:pt-16 xl:pb-32 pt-12 pb-24">
      ...
      <div className="flex flex-row xl:gap-32 gap-24 items-center">
        <div className="text-text w-6/12 text-sm space-y-3">
          <motion.p initial={{ y: 1000 }} animate={{ y: 0 }} transition={textAnimationAbout}>I am a dedicated <span className="font-bold brown-block">Front-end Developer</span> with a sharp eye for detail and a commitment to building websites that achieve <span className="font-bold brown-block">pixel-perfect</span> precision. </motion.p>
