...
export default function AboutCard() {
  ...
  return (
    <div className="container mx-auto flex w-full flex-col lg:pt-16 lg:pb-32 pt-4 pb-24">
      <div className="mb-4">
        <motion.h2 initial={{ y: 1000 }} animate={{ y: 0 }} transition={textAnimationAbout} className="text-text font-bold text-2xl lg:text-4xl">About Me</motion.h2>
      </div>
      <div className="flex flex-col lg:flex-row gap-8 lg:gap-24 xl:gap-32 items-center">
        ...
        <div className="w-full lg:w-6/12 relative h-full">          
          <motion.p initial={{ y: 1000 }} animate={{ y: 0 }} transition={textAnimationAbout} className="text-text text-lg lg:text-2xl text-center">
